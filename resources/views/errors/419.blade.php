...
<head>
    ...
    <title>419 - Phiên làm việc hết hạn | GREECO</title>
    ...
    <style>
        * {
        ...
        /* Keyframes */
        @keyframes pulseCode {
            0%, 100% { transform: scale(1); filter: drop-shadow(0 0 10px rgba(245, 158, 11, 0.2)); }
            50% { transform: scale(1.03); filter: drop-shadow(0 0 20px rgba(245, 158, 11, 0.4)); }
        }
...
<body>
    ...
    <div class="container">
        <div class="error-card">
            ...
            <p class="error-msg">Trang yêu cầu đã hết hạn do bạn không tương tác trong thời gian dài trên hệ thống GREECO. Vui lòng quay lại hoặc tải lại trang.</p>
