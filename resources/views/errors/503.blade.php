...
<head>
    ...
    <title>503 - Hệ thống đang bảo trì | GREECO</title>
    ...
    <style>
        * {
        ...
        @keyframes pulseCode {
            ...
            50% { transform: scale(1.03); filter: drop-shadow(0 0 20px rgba(16, 185, 129, 0.4)); }
        }
...
<body>
    ...
    <div class="container">
        <div class="error-card">
            ...
            <h2 class="error-title">Hệ thống đang bảo trì</h2>
            <p class="error-msg">Hệ thống GREECO đang thực hiện cập nhật hoặc nâng cấp dịch vụ để mang lại trải nghiệm tốt nhất. Vui lòng quay lại sau ít phút.</p>
