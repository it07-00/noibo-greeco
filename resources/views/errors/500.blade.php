...
<head>
    ...
    <title>500 - Lỗi máy chủ nội bộ | GREECO</title>
    ...
    <style>
        * {
        ...
        /* Keyframes */
        @keyframes pulseCode {
            0%, 100% { transform: scale(1); filter: drop-shadow(0 0 10px rgba(124, 58, 237, 0.2)); }
            50% { transform: scale(1.03); filter: drop-shadow(0 0 20px rgba(124, 58, 237, 0.4)); }
        }
...
<body>
    ...
    <div class="container">
        <div class="error-card">
            ...
            <p class="error-msg">Đã xảy ra sự cố không mong muốn trên máy chủ của hệ thống GREECO. Ban quản trị đang tiến hành khắc phục sớm nhất.</p>
