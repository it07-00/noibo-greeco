...
<head>
    ...
    <title>403 - Không có quyền truy cập | GREECO</title>
    ...
    <style>
        * {
        ...
        /* Keyframes */
        @keyframes pulseCode {
            0%, 100% { transform: scale(1); filter: drop-shadow(0 0 10px rgba(239, 68, 68, 0.2)); }
            50% { transform: scale(1.03); filter: drop-shadow(0 0 20px rgba(239, 68, 68, 0.4)); }
        }
...
<body>
    ...
    <div class="container">
        <div class="error-card">
            ...
            <p class="error-msg">Bạn không được phân quyền để thực hiện hành động này hoặc truy cập vào trang hiện tại trên hệ thống GREECO.</p>
