...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styles.css') }}?v=1.0.6">
    <link rel="stylesheet" href="{{ asset('css/greeco.css') }}?v=1.0.6">
    ...
    <script>
        (() => {
            ...
            const bindings = {
                ...
                'customer-form:show': ['customerFormModal', 'show'],
                'customer-form:hide': ['customerFormModal', 'hide'],
                'quotation-form:show': ['quotationFormModal', 'show'],
                'quotation-form:hide': ['quotationFormModal', 'hide'],
                'contract-info:show': ['contractInfoModal', 'show'],
                'contract-info:hide': ['contractInfoModal', 'hide'],
                'payment-schedule:show': ['paymentScheduleModal', 'show'],
                'payment-schedule:hide': ['paymentScheduleModal', 'hide'],
                'payment-record:show': ['paymentRecordModal', 'show'],
                'payment-record:hide': ['paymentRecordModal', 'hide'],
                'payment-return:show': ['paymentReturnModal', 'show'],
                'payment-return:hide': ['paymentReturnModal', 'hide'],
                'sales-target:show': ['salesTargetModal', 'show'],
                'sales-target:hide': ['salesTargetModal', 'hide'],
                'contract-document:show': ['contractDocumentModal', 'show'],
